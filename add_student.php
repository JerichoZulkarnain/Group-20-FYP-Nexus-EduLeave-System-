...
if(isset($_SESSION['new_student'])) {
    $success_data = $_SESSION['new_student'];
...
<head>
    ...
    <style>
        ...
        /* Success Popup - Exact match to your picture */
        .popup-overlay {
...
<div class="form-card">
    <div class="form-header">
        <h1><i class="fa-solid fa-user-plus"></i> Create Student Account</h1>
    </div>
    ...
    <div class="form-body">
        <form action="process_add_student.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nexus_id" required placeholder="STUxxxx">
                <div class="password-hint">Must start with STU followed by numbers</div>
            </div>
...
<!-- Success Popup - Exact match to your 4th picture -->
<?php if($success_data): ?>
