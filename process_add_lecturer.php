...
logActivity($conn, $_SESSION['user']['id'], $_SESSION['user']['full_name'], $_SESSION['user']['role'], 'Account Creation', 'Created new lecturer account: ' . $full_name . ' (' . $nexus_id . ')');
    ...
    if(mysqli_query($conn, $sql)) {
        if($send_email) {
            ...
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Your Nexus EduLeave System Lecturer Account';
                $mail->Body    = "
                    <div style='font-family:Arial,sans-serif;max-width:500px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;'>
                        ...
                        <div style='padding:25px;'>
                            ...
                            <p>Your lecturer account has been created in the Nexus EduLeave System.</p>
