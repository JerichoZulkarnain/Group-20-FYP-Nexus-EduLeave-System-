...
<head>
    <meta charset="UTF-8">
    <title>Lecturer Profile - Nexus</title>
...
<div class="sidebar">
    ...
    <nav class="nav-menu">
        ...
        <a href="profile_lecturer.php" class="nav-link active">
        ...
        <div class="profile-card">
                ...
                <?php if($edit_mode): ?>
                    ...
                    <form method="POST" class="profile-info-edit-mode">
                        ...
                        <div style="margin-top: 25px;">
                            ...
                            <a href="profile_lecturer.php" class="cancel-btn"><i class="fa-solid fa-times"></i> Cancel</a>
                        </div>
                    </form>
                <?php else: ?>
                    <!-- VIEW MODE -->
            ...
            <?php if(!$edit_mode): ?>
                <div style="margin-top:15px;">
                    <div class="profile-badge">Status: A / Active</div>
                    <br>
                    <div class="profile-badge">Account Type: Lecturer</div>
                </div>
            <?php endif; ?>

            <div class="profile-actions">
                <?php if($edit_mode): ?>
                    <a href="profile_lecturer.php" class="profile-btn">View Profile</a>
                <?php else: ?>
                    <a href="profile_lecturer.php?edit=1" class="profile-btn">Edit Profile</a>
